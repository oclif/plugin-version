...
```bash
$ git clone git@github.com:oclif/plugin-version.git
```

**2. Navigate into project & install development-specific dependencies...**

```bash
$ cd ./plugin-version && yarn
```
...
**6. Open a [Pull Request](https://github.com/oclif/plugin-version/pulls) for your work & become the newest contributor to `@oclif/plugin-version`! 🎉**
